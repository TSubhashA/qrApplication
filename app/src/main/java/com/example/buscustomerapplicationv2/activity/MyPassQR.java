...
public class MyPassQR extends MenuActivity {
    ...
    TextView passNameTV, routeAvailTV, remainingTripsTV, expiryTv;
...
//        );
        ...
        passNameTV=findViewById(R.id.pass_name);
        routeAvailTV=findViewById(R.id.pass_route_applicable);
        remainingTripsTV=findViewById(R.id.remaining_trips);
        expiryTv=findViewById(R.id.expiry_on);
